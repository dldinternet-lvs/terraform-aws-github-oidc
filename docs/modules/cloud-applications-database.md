...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aurora"></a> [aurora](#module\_aurora) | ../../modules/db | n/a |
...
| <a name="input_db_cluster_name"></a> [db\_cluster\_name](#input\_db\_cluster\_name) | Name for the cluster | `string` | `null` | no |
...
| <a name="input_db_cluster_revision"></a> [db\_cluster\_revision](#input\_db\_cluster\_revision) | Revision number for the cluster | `number` | `null` | no |
...
| <a name="output_db_secret_id_map"></a> [db\_secret\_id\_map](#output\_db\_secret\_id\_map) | ############################################################################### Postgres Setup ############################################################################### secrets manager |
