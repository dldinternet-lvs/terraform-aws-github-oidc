...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aurora"></a> [aurora](#module\_aurora) | git@github.com:SandsB2B/terraform-aws-rds-aurora | b2b-0.34.58 |
...
| <a name="module_nlb"></a> [nlb](#module\_nlb) | git@github.com:SandsB2B/terraform-aws-alb | b2b-0.34.58 |
| <a name="module_nlb_reader"></a> [nlb\_reader](#module\_nlb\_reader) | git@github.com:SandsB2B/terraform-aws-alb | b2b-0.34.58 |
| <a name="module_postgres-setup"></a> [postgres-setup](#module\_postgres-setup) | ../postgres-setup | n/a |
...
| [aws_secretsmanager_secret.rds_admin_connection](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/secretsmanager_secret) | resource |
| [aws_secretsmanager_secret.rds_database_list](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/secretsmanager_secret) | resource |
| [aws_secretsmanager_secret.rds_database_map](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/secretsmanager_secret) | resource |
| [aws_secretsmanager_secret_version.rds_admin_connection](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/secretsmanager_secret_version) | resource |
| [aws_secretsmanager_secret_version.rds_database_list](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/secretsmanager_secret_version) | resource |
| [aws_secretsmanager_secret_version.rds_database_map](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/secretsmanager_secret_version) | resource |
| [time_sleep.wait_for_cluster](https://registry.terraform.io/providers/hashicorp/time/latest/docs/resources/sleep) | resource |
| [dns_a_record_set.reader](https://registry.terraform.io/providers/hashicorp/dns/3.3.2/docs/data-sources/a_record_set) | data source |
| [dns_a_record_set.writer](https://registry.terraform.io/providers/hashicorp/dns/3.3.2/docs/data-sources/a_record_set) | data source |
...
| <a name="input_cluster_name"></a> [cluster\_name](#input\_cluster\_name) | Name for the cluster | `string` | `null` | no |
| <a name="input_cluster_revision"></a> [cluster\_revision](#input\_cluster\_revision) | Revision number for the cluster | `number` | `null` | no |
...
| <a name="input_cluster_use_name_prefix"></a> [cluster\_use\_name\_prefix](#input\_cluster\_use\_name\_prefix) | Whether to use `name` as a prefix for the cluster | `bool` | `true` | no |
...
| <a name="input_create"></a> [create](#input\_create) | Determines whether to create the database | `bool` | `true` | no |
...
| <a name="input_create_connection_secrets"></a> [create\_connection\_secrets](#input\_create\_connection\_secrets) | Determines whether to create the database connection secrets | `bool` | `false` | no |
| <a name="input_create_database_secrets"></a> [create\_database\_secrets](#input\_create\_database\_secrets) | Determines whether to create the database list/map secrets | `bool` | `false` | no |
...
| <a name="input_create_nlbs"></a> [create\_nlbs](#input\_create\_nlbs) | Determines whether to create the database NLBs | `bool` | `false` | no |
...
| <a name="input_kms_create_key"></a> [kms\_create\_key](#input\_kms\_create\_key) | Whether to create a KMS key for the database storage | `bool` | `false` | no |
...
| <a name="input_recovery_window_in_days"></a> [recovery\_window\_in\_days](#input\_recovery\_window\_in\_days) | Secret recovery\_window\_in\_days. Defaults to `7` | `number` | `7` | no |
...
| <a name="input_revision"></a> [revision](#input\_revision) | Revision number of the database resources. Defaults to `1` | `number` | `1` | no |
...
| <a name="input_user_db_names"></a> [user\_db\_names](#input\_user\_db\_names) | A list of userspace (non-admin) databases/roles to create.  Currently only implemented for postgres | `list(string)` | `[]` | no |
| <a name="input_user_db_spaces"></a> [user\_db\_spaces](#input\_user\_db\_spaces) | A map of userspace (non-admin) databases/roles to create.  Currently only implemented for postgres | `map(any)` | `{}` | no |
...
| <a name="output_db_role_name_map"></a> [db\_role\_name\_map](#output\_db\_role\_name\_map) | Role |
| <a name="output_db_secret_arn_map"></a> [db\_secret\_arn\_map](#output\_db\_secret\_arn\_map) | n/a |
| <a name="output_db_secret_id_map"></a> [db\_secret\_id\_map](#output\_db\_secret\_id\_map) | secrets manager |
| <a name="output_db_secret_version_arn_map"></a> [db\_secret\_version\_arn\_map](#output\_db\_secret\_version\_arn\_map) | n/a |
| <a name="output_db_secret_version_id_map"></a> [db\_secret\_version\_id\_map](#output\_db\_secret\_version\_id\_map) | n/a |
...
| <a name="output_kms_create_key"></a> [kms\_create\_key](#output\_kms\_create\_key) | Create KMS key |
| <a name="output_kms_key_id"></a> [kms\_key\_id](#output\_kms\_key\_id) | KMS key Id/ARN |
| <a name="output_rds_admin_connection_secret_arn"></a> [rds\_admin\_connection\_secret\_arn](#output\_rds\_admin\_connection\_secret\_arn) | RDS admin connection secret ARN |
| <a name="output_rds_admin_connection_secret_id"></a> [rds\_admin\_connection\_secret\_id](#output\_rds\_admin\_connection\_secret\_id) | RDS admin connection secret ID |
| <a name="output_reader_endpoint_ip_addresses"></a> [reader\_endpoint\_ip\_addresses](#output\_reader\_endpoint\_ip\_addresses) | IP addresses of the reader endpoint |
| <a name="output_reader_lb_arn"></a> [reader\_lb\_arn](#output\_reader\_lb\_arn) | The ID and ARN of the load balancer we created |
| <a name="output_reader_lb_dns_name"></a> [reader\_lb\_dns\_name](#output\_reader\_lb\_dns\_name) | The DNS name of the load balancer |
| <a name="output_reader_lb_id"></a> [reader\_lb\_id](#output\_reader\_lb\_id) | The ID and ARN of the load balancer we created |
| <a name="output_reader_lb_zone_id"></a> [reader\_lb\_zone\_id](#output\_reader\_lb\_zone\_id) | The zone\_id of the load balancer to assist with creating DNS records |
| <a name="output_reader_security_group_arn"></a> [reader\_security\_group\_arn](#output\_reader\_security\_group\_arn) | Amazon Resource Name (ARN) of the security group |
| <a name="output_reader_security_group_id"></a> [reader\_security\_group\_id](#output\_reader\_security\_group\_id) | ID of the security group |
...
| <a name="output_writer_endpoint_ip_addresses"></a> [writer\_endpoint\_ip\_addresses](#output\_writer\_endpoint\_ip\_addresses) | IP addresses of the writer endpoint |
| <a name="output_writer_lb_arn"></a> [writer\_lb\_arn](#output\_writer\_lb\_arn) | The ID and ARN of the load balancer we created |
| <a name="output_writer_lb_dns_name"></a> [writer\_lb\_dns\_name](#output\_writer\_lb\_dns\_name) | The DNS name of the load balancer |
| <a name="output_writer_lb_id"></a> [writer\_lb\_id](#output\_writer\_lb\_id) | The ID and ARN of the load balancer we created |
| <a name="output_writer_lb_zone_id"></a> [writer\_lb\_zone\_id](#output\_writer\_lb\_zone\_id) | The zone\_id of the load balancer to assist with creating DNS records |
| <a name="output_writer_security_group_arn"></a> [writer\_security\_group\_arn](#output\_writer\_security\_group\_arn) | Amazon Resource Name (ARN) of the security group |
| <a name="output_writer_security_group_id"></a> [writer\_security\_group\_id](#output\_writer\_security\_group\_id) | ID of the security group |
