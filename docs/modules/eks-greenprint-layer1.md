...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws_eks"></a> [aws\_eks](#module\_aws\_eks) | git@github.com:SandsB2B/terraform-aws-eks.git | b2b-0.34.58 |
...
| <a name="input_cluster_encryption_config"></a> [cluster\_encryption\_config](#input\_cluster\_encryption\_config) | Configuration block with encryption configuration for the cluster | `list(object({ provider_key_arn : string, resources : list(string) }))` | `[]` | no |
...
| <a name="input_kms_key_arn"></a> [kms\_key\_arn](#input\_kms\_key\_arn) | A valid EKS Cluster KMS Key ARN to encrypt Kubernetes secrets | `string` | `null` | no |
...
| <a name="output_cluster_arn"></a> [cluster\_arn](#output\_cluster\_arn) | Amazon EKS Cluster Name |
...
| <a name="output_oidc_issuer_url"></a> [oidc\_issuer\_url](#output\_oidc\_issuer\_url) | The URL on the EKS cluster OIDC Issuer |
