...
| <a name="module_eks_vpc"></a> [eks\_vpc](#module\_eks\_vpc) | ../vpc | n/a |
...
| <a name="output_kubeconfigs"></a> [kubeconfigs](#output\_kubeconfigs) | Kubeconfig files for the EKS cluster |
